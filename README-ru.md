...
*Графическое представление СКА (слева) и ее модификации λ-СКА (справа).*
...
*Результаты обучения и анализа λ-СКА для иона $Cr^{3+}$.*

*__Левый верхний угол:__ парные графики истинных и оценённых концентраций ионов; __Правый верхний угол:__ гистограмма распределения косинусной метрики между вектором λ-коэффициентов и истинным градиентным вектором предсказания модели по входным каналам. __Нижняя половина:__ три гистограммы, оценивающие важность входных признаков методами SHAP-анализа, градиентного анализа и анализа λ-СКА-коэффициентов соответственно.*
...
Обучение и интерпретация СКА и $\lambda$-СКА на части данных представлена в __Interpretability/Demo.ipynb__. 
Просто склонируйте репозиторий и запустите все ячейки данного ноутбука.

Или откройте демо в colab: https://colab.research.google.com/github/Gavr101/Spectroscopy_FL_4_ions/blob/main/Interpretability/Demo_colab.ipynb
...
2) *Interpretability* : исследование интерпретации СКА при решении обратной задачи спектроскопии.
    ...
    * Demo/Demo_colab.ipynb - демонстрация возможностей KAN / $\lambda$-KAN
...
3) *Вспомогательный код*:
    ...
    * data_example - часть данных датасета. Используется в демонстрационных ноутбуках
---