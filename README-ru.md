...
_Графическое представление СКА (слева) и ее модификации $\lambda$-СКА (справа)._
...
_Результаты обучения и анализа $\lambda$-СКА для иона $Cr^{3+}$._

___Левый верхний угол:__ парные графики истинных и оценённых концентраций ионов; __Правый верхний угол:__ гистограмма распределения косинусной метрики между вектором $\lambda$-коэффициентов и истинным градиентным вектором предсказания модели по входным каналам. __Нижняя половина:__ три гистограммы, оценивающие важность входных признаков методами SHAP-анализа, градиентного анализа и анализа $\lambda$-СКА-коэффициентов соответственно._
